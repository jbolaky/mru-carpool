...
<table width="60%">
	<tr>
		...
		<span id="spryradio1">
		<td>
		<div align="center" class="radio_button"><input type="radio"
			name="RadioGroup1" value="radio" id="RadioGroup1_0" /> <label>Yes</label>
		</div>
		</td>
		<td>
		<div align="center" class="radio_button"><input type="radio"
			name="RadioGroup1" value="radio" id="RadioGroup1_1" /> <label>No</label>
		</div>
		</td>
		</span>
	</tr>
	<tr>
		...
		<td>
		<div align="center" class="radio_button"><input type="radio"
			name="RadioGroup2" value="radio" id="RadioGroup2_0" /> <label>Yes</label>
		</div>
		</td>
		<td>
		<div align="center" class="radio_button"><input type="radio"
			name="RadioGroup2" value="radio" id="RadioGroup2_1" /> <label>No</label>
		</div>
		</td>
		</span>
	</tr>
	<tr>
		...
		<td>
		<div align="center" class="radio_button"><input type="radio"
			name="RadioGroup3" value="radio" id="RadioGroup3_0" /> <label>Yes</label>
		</div>
		</td>
		<td>
		<div align="center" class="radio_button"><input type="radio"
			name="RadioGroup3" value="radio" id="RadioGroup3_1" /> <label>No</label>
		</div>
		</td>
		</span>
	</tr>
...
<table class="ur_contact_details" width="80%">
	...
	<tr>
		<td><input size="40%" type="text" name="address" id="address" />
		</td>
		<td><input size="10%" type="text" name="postcode" id="postcode" />
		</td>
		<td><input size="17%" type="text" name="phone" id="phone" /></td>
	</tr>
</table>

<h2 class="item">Your Preferences</h2>
<input name="notification" type="checkbox" value="" /> <label>I
would like to recieve updates on new Car Pools for my area</label>
<table width="60%" class="topspace">
	...
	<tr>
		...
		<td>
		<div align="center" class="radio_button"><input type="radio"
			name="RadioGroup4" value="radio" id="RadioGroup4_0" /> <label>Yes</label>
		</div>
		</td>
		<td>
		<div align="center" class="radio_button"><input type="radio"
			name="RadioGroup4" value="radio" id="RadioGroup4_1" /> <label>No</label>
		</div>
		</td>
		</span>
	</tr>
